...
# *modified "Thu Mar 10 11:30:17 2022" *by "Paul E. Black"
...
testCLI: TestCLI1 TestCLI2 TestCLI3

# unknown language
TestCLI1:
	python3 vtsg.py -l unknownLang | tee $(@)_photo
...
TestCLI3:
	python3 vtsg.py -l test010 -c IDS00-PL | tee $(@)_photo
