...
import os
import sys
# like import 'CWE78__I_args__F_no_bad_chars__S_ls__1-70cib.py' as module70ci
...
loader = importlib.machinery.SourceFileLoader('SFL', os.path.join(path_to_parent,
                                'CWE78__I_args__F_no_bad_chars__S_ls__1-70cib.py'))
...
def main():
    ...
    de_queue.append(module70ci.Class_1(tainted_0))
    var_1 = de_queue.pop()
