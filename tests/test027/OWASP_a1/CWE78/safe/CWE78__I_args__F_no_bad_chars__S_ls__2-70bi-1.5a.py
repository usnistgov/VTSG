...
import string
import sys
# like import 'CWE78__I_args__F_no_bad_chars__S_ls__2-70bi-1.5b.py' as module_1
import importlib.machinery
import importlib.util
import pathlib
path_to_parent = str(pathlib.Path(__file__).parent) + '/' # SKIMP use os.path.join()
loader = importlib.machinery.SourceFileLoader('SFL', path_to_parent+'CWE78__I_args__F_no_bad_chars__S_ls__2-70bi-1.5b.py')
...
def main():
    ...
    var_2 = module_1.Class_2(tainted_2)
