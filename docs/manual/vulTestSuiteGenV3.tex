...
% *modified "Thu Jan  5 09:04:00 2023" *by "Paul E. Black"
...
When VTSG has selected a set of modules, composes
...
\begin{itemize}
    \item dir and path: see Sec.~\ref{sec:module description}.
...
\begin{itemize}
    ...
    \item Divide by Zero (CWE-369) (no flaw group)
    \item Loop on Unchecked Input (CWE-606) (no flaw group)
\end{itemize}
...
j16e & while True code break \\
\hline
j16n & while True break code \\
\hline
...
\hline
\end{tabular}
\caption{IDs and Pseudocode of Complexities Defined for Python}
...
\hline
\end{tabular}
\caption{ID, Code, and Value to which it evaluates of Conditions Defined for
  Python}
