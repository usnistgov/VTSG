...
% *modified "Wed Sep 13 15:59:54 2023" *by "Paul E. Black"
...
In practice, a tool must analyze much of the program, noting its control and
...
The information in this manual is divided into several section.  The next section,
...
VTSG generates both the unsafe (buggy or vulnerable)
...
(non-vulnerable) and unsafe (vulnerable) test cases it generated in each group and
...
packages installed on their Linux machines.  Users who already have these
...
\begin{itemize}[nosep]
    \item OS Command Injection (CWE78) (OWASP\_a1)
