...
% *modified "Tue Mar 28 14:29:45 2023" *by "Paul E. Black"
...
influenced by loops, conditionals, and function calls.
...
section explains how to use INDENT and DEDENT to encsure correct indentation in the
final source code.
...
\begin{itemize}
    ...
    Tip: To generate a test without functional filtering, assign \verb|in_var_name|
    to \verb|out_var_name| in the code, e.g.,
\begin{verbatim}
...
\end{verbatim}
    ...
    Making the input\_type \verb|nofilter| prevents the filter from being wrapped
    in any complexity.
