...
% *modified "Wed Dec 14 14:36:53 2022" *by "Paul E. Black"
...
\begin{itemize}
    ...
    \item options: By default filters are wrapped in complexities.  Complexities may
      ...
      words, if \verb|need_complexity| appears with anything other than ``1'', no
      variations with complexities are generated.
