...
% *modified "Tue Jul 18 16:25:33 2023" *by "Paul E. Black"
...
All the language information files are accessed from a single subdirectory by
default.  The default is \verb|src/templates|.  A different directory may be
...
The user may select which cases VTSG composes and writes two ways; see
