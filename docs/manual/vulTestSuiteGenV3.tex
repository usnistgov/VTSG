...
% *modified "Mon Sep 18 15:32:44 2023" *by "Paul E. Black"
...
supporting packages, add new flaw classes, sinks, inputs, etc.\ to % not sentence end
existing languages
...
\begin{verbatim}
    if index < len(array):
        print(array[index])
\end{verbatim}
We discovered the mistake when we executed the cases and ``unsafe'' cases did
