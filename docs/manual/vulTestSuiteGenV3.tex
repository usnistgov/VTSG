...
% *modified "Thu Mar  2 09:48:36 2023" *by "Paul E. Black"
...
\begin{itemize}
    ...
    \item output\_type: the type of output.  The variable generated with the
      ...
      An input module is selected if it matches the \verb|input_type| of the Filter or
...
\begin{itemize}
    ...
    \verb|out_var_name| in the code, e.g.,
\begin{verbatim}
