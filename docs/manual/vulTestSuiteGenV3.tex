...
% *modified "Tue Mar 15 09:56:00 2022" *by "Paul E. Black"
...
\verb|manifest.xml|.
Under the flaw type directory are directories for safe or unsafe test cases, depending on
which are generated.
...
\begin{itemize}
    ...
    all types of flaws, put \verb|ALL| in the ``flaw\_type'' attribute.
