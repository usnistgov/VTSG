...
% *modified "Wed Jan  4 11:41:30 2023" *by "Paul E. Black"
...
\verb|QUERY__NMBCPLX-CPLX1-CPLX2.CONDx.EXT|
\begin{itemize}
    ...
    \item NMBCPLX:  The number of complexities. Each complexity has the tags
    \begin{itemize}
        \item CPLX1, CPLX2, \ldots: ID given in 
            ...
            complexity IDs used in \CSharp\ and PHP.  If the complexity has a
            condition, COND is the ID given in test condition modules,
