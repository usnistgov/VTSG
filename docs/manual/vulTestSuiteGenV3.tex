...
% *modified "Wed Sep 28 10:59:29 2022" *by "Paul E. Black"
...
Under the flaw type directory there are directories for safe or unsafe
...
\begin{itemize}
    ...
    \begin{itemize}
        \item CPLX1, CPLX2, \ldots: ID given in 
            ...
            see Sec.~\ref{sec: complexity modules} and
            tables \ref{tab:complexity IDs for CSharp} or
            \ref{tab:complexity IDs for PHP} in
            language appendixes.
            (optional)
...
20 means the sink code is executed in the class body,
